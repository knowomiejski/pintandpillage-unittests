...
public class House extends Building implements IPopulatable {
    ...
    public void updateBuilding() {
        // TODO: changed Math.pow(1.32, super.getLevel()) to Math.pow(super.getLevel(), 1.32) based on other buildings
        this.populationCapacity = super.getLevel() == 0 ? 0 : (int) (8 * (super.getLevel() * super.getLevel()) + 10 * Math.pow(super.getLevel(), 1.32));
