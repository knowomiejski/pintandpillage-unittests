...
public abstract class ResearchBuilding extends Building {
    ...
    public void startResearch(Research research) {
        this.checkIsAbleToStartResearch(research);
        this.currentResearch = research;
        research.setVillage(super.getVillage());
        this.isResearchInProgress = true;
        //TODO: should modify research time based on research and building level
        ...
        //TODO: should add a call to update the required resources of a research
    }

    //TODO: changedName from checkIsAbaleToStartResearch
    private void checkIsAbleToStartResearch(Research research) {
