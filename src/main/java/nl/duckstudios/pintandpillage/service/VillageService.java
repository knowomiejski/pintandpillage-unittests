...
public class VillageService {
    ...
    public Village createBuilding(Village village, Building building) {
        //TODO: check if given building has the right coordinates to be build
        //TODO: check if headquarters already in village (maybe a Building.canBeBuild(Village village) method?)
    ...
    public void checkIsValidCreatingSpot(Village village, Coord newPosition) {
        //TODO: if jarl does not exist also throw the exception
        if (village.getUnitInVillage(UnitType.Jarl) == null || village.getUnitInVillage(UnitType.Jarl).getAmount() < 1){
    ...
    // TODO: made protected
    protected void updateCombatState(Village village) {
        ...
        //merge all travels and sort by time of arrival
    ...
    // TODO: protected for tests
    protected void fight(AttackCombatTravel travel) {
        this.attack(travel);
    ...
    // TODO: protected for tests
    protected void attack(AttackCombatTravel travel) {
        // this one is fun too!
        // 5 * (1.1) * 10
        int attackingVillageStat = travel.getTravelingUnits().stream()
                .mapToInt(t -> (int) (t.getUnit().getAttack() * (1 + 0.1f * travel.getAttackingVillage().getResearchLevel(t.getUnit().getResearchRequired())) * t.getAmount())).sum();
        ...
        if (difference > 0) {
            ...
            // percent lost is actually percent survived
    ...
    // TODO: protected for tests
    protected void loseBattle(AttackCombatTravel travel, float percentLost) {
    ...
    // TODO: protected for tests
    protected void winBattle(AttackCombatTravel travel, float percentLost) {
    ...
    // TODO: protected for tests
    protected ReturningCombatTravel createReturnTravel(AttackCombatTravel travel) {
    ...
    // TODO: protected for tests
    protected void returnUnits(Village village, ReturningCombatTravel travel) {
